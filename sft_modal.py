...
def run_pipeline() -> None:
    """Pretrain d24 relu2+RoPE10K → SFT baseline → upload → SFT enhanced → upload → evals."""
    _setup_cache()
    print("\n" + "="*60)
    ...
    # [3] Pretrain d24 — relu2 + RoPE 10K (Karpathy's original, NOT swiglu)
    print("[3/8] Pretraining d24 (relu2 + RoPE 10K)...")
